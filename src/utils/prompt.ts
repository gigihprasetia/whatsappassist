export const promptData = {
  summarizeQuerySearch: `
    ...
    `,
  checkHoax: `
    Berdasarkan artikel berikut ini, analisislah apakah topik dibawah ini apakah hoax atau bukan. berikan penjelasan singkat . pada kalimat terakhir tulislah KESIMPULAN: HOAX/TIDAK HOAX
    `,
